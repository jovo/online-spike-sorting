...
Below, we describe an iteration of our algorithm the case a single electrode; %Most steps are repeated across all electrodes; 
...
\begin{align}
  \resx_t = x_t - \sum_{h=1}^L \bD\mh{\by}_{t-h} \label{eq:resid}
\end{align}
