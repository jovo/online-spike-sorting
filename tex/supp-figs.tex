...
\begin{figure}[htbp]
	...
	\caption{(a) This shows the average number of true positives versus the average number of false positives in the intracellular cluster for 2 minute segments of the 4 minutes of the experiment.  \smug\ does better than all the competitors. \jovo{this plot doesn't exist yet} }
	\label{fig:asdf}
\end{figure}
