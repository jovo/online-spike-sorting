...
%More broadly, we can view the superposed process $E$ as a rate $\Lambda$ Poisson process, with each event having a pair of marks, the neuron identity $i$,
